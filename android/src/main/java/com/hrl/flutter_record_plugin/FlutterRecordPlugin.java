...
/** FlutterRecordPlugin */
public class FlutterRecordPlugin implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_record_plugin");
    channel.setMethodCallHandler(new FlutterRecordPlugin(registrar));
  }


    private FlutterRecordPlugin(Registrar registrar){
